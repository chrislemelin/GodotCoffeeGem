...
public partial class Gem : lerp
{
	...
	[Export] RichTextLabel leadLevelText;
	...
	public void incrementLeadLevel(int increment) {
		leadLevel += increment;
		leadLevelText.Visible = true;
		leadLevelText.Text = TextHelper.centered(leadLevel.ToString());
	}
	public void incrementLeadLevel() {
		incrementLeadLevel(1);
	}
	...
	private void updateSprite() {
		...
		if (!Type.Equals(GemType.Lead)) {
			leadLevelText.Visible = false;
		}
	}
